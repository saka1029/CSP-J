...
public class 春からみんな新生活 extends SolverMain {
    ...
    public void define() throws IOException {
        allDifferent(セツオ.年齢, イクミ.年齢, カナコ.年齢, シンイチ.年齢, ツキコ.年齢);
        allDifferent(セツオ.新生活, イクミ.新生活, カナコ.新生活, シンイチ.新生活, ツキコ.新生活);
        ...
        or(and(eq(セツオ.新生活, 新生活.転職), eq(セツオ.年齢, 25)),
            and(eq(カナコ.新生活, 新生活.転職), eq(カナコ.年齢, 25)),
            and(eq(シンイチ.新生活, 新生活.転職), eq(シンイチ.年齢, 25)),
            and(eq(ツキコ.新生活, 新生活.転職), eq(ツキコ.年齢, 25)));
        ...
        // 　　　　　　ところで、３０才の記念にペットを飼い始めたのは誰だっけ？
        lt(シンイチ.年齢, カナコ.年齢);
        or(and(eq(セツオ.新生活, 新生活.ペットを飼う), eq(セツオ.年齢, 30)),
            and(eq(イクミ.新生活, 新生活.ペットを飼う), eq(イクミ.年齢, 30)),
            and(eq(カナコ.新生活, 新生活.ペットを飼う), eq(カナコ.年齢, 30)),
            and(eq(ツキコ.新生活, 新生活.ペットを飼う), eq(ツキコ.年齢, 30)));
