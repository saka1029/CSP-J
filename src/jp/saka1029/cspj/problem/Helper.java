...
public class Helper {
    ...
    static final String LOG_CONFIG = "java.util.logging.config.file";
    static final String LOG_FILE = "logging.properties";

    static {
        if (System.getProperty(LOG_CONFIG) == null)
            System.setProperty(LOG_CONFIG, LOG_FILE);
    }
